...
const W = (n) => (K("data-v-b61f7390"), n = n(), U(), n), X = { class: "c-operate" }, Z = /* @__PURE__ */ W(() => /* @__PURE__ */ A("span", { class: "c-operate-more-text" }, "\u66F4\u591A", -1)), ee = { class: "c-operate-more-text" }, te = {
  name: "COperate"
}, ne = /* @__PURE__ */ I({
  ...te,
  props: {
  ...
  setup(n) {
    ...
    return (p, k) => {
      ...
      return s(), u("div", X, [
        n.type === "overStep" ? (s(), u(C, { key: 0 }, [
          (s(!0), u(C, null, L(f(d).outsideList, (o, y) => (s(), g(c, x({
          ...
          f(d).insideList.length ? (s(), g(i, {
            ...
            dropdown: l(() => [
              _(t, null, {
                default: l(() => [
                  (s(!0), u(C, null, L(f(d).insideList, (o, y) => (s(), g($, {
                    key: y,
                    disabled: o.disabled,
                    command: o
                  }, {
        ...
        n.type === "custom" ? (s(!0), u(C, { key: 1 }, L(a.columns, (o, y) => (s(), u(C, { key: y }, [
          o.children && Array.isArray(o.children) ? (s(), g(i, {
            ...
            dropdown: l(() => [
              _(t, null, {
                default: l(() => [
                  (s(!0), u(C, null, L(o.children, (h, e) => (s(), g($, {
                    key: e,
                    disabled: h.disabled,
                    command: h
                  }, {
...
const O = (n, a) => {
  ...
  for (const [r, p] of a)
    d[r] = p;
  return d;
}, V = /* @__PURE__ */ O(ne, [["__scopeId", "data-v-b61f7390"]]), ae = { class: "c-status" }, oe = {
  key: 0,
  class: "dot"
}, se = {
  name: "CStatus"
    ...
    return (t, i) => {
      ...
      return s(), u("div", le, [
        _(y, x(t.$attrs, E(t.$attrs), { class: "c-table" }), {
          default: l(() => [
            (s(!0), u(C, null, L(n.columns, (e, F) => (s(), g(o, x({ key: F }, e, E(e)), {
              default: l((v) => [
